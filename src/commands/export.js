...
function exportLore() {
  ...
  try {
    ...
    // Sort each group newest-first so CLAUDE.md leads with the most relevant rules
    ...
    let md = '# Project Lore\n';
    md +=
      '> Auto-generated by lore export. Do not edit manually — run `lore export` to regenerate.\n\n';
    ...
    console.log(
      chalk.green(
        '✓ CLAUDE.md written to project root — Claude Code will read this on next session start'
      )
    );
  } catch (e) {
